...
Sub CreateOrganizationStructureDiagram()
    ...
    If orgDiagram Is Nothing Then
        Set orgDiagram = phaseBPackage.Diagrams.AddNew("OnEdge Organization Structure", "Class")
    ...
    Session.Output "OnEdge Organization Structure created successfully under MODEL > Architecture Development Method > Phase B"
    Session.Output "Done!"
End Sub
